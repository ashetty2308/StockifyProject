...
public class Act_news_nine extends AppCompatActivity {
    @Override
    ...
    private class GetArticleDetails extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            floatingActionButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        databaseReference1.setValue(stringData.getJSONArray("results").getJSONObject(8).get("title").toString());
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
            ...
            try {
                String captionStr = stringData.getJSONArray("results").getJSONObject(8).get("description").toString();
            ...
            try {
                String authorStr = stringData.getJSONArray("results").getJSONObject(8).get("creator").toString();
            ...
            try {
                String storyStr = stringData.getJSONArray("results").getJSONObject(8).get("content").toString();
            ...
            try {
                continueReading.setText("Link to Article: " +stringData.getJSONArray("results").getJSONObject(8).get("link").toString());
            } catch (JSONException e) {
                e.printStackTrace();
            }
